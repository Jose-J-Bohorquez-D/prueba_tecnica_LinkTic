...
import com.linktic.test.products.dto.ErrorObject;
import com.linktic.test.products.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ErrorObject error = ErrorObject.builder()
                ...
                .detail("A resource with the same unique identifier already exists.") // Mensaje genérico para no exponer detalles
                .build();
        return new ResponseEntity<>(new ErrorResponse(Collections.singletonList(error)), HttpStatus.CONFLICT);
    }
